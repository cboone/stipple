# stipple v0.5.0 Implementation Plan: Color Support
...
- Ensure visual tests respect the existing `-visual` flag pattern
...
Add `math` import for colored eyeball demo, keeping imports alphabetized.
